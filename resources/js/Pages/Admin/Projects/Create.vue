...
const form = useForm({
    ...
    project_images: [], // Array for multiple project images
    tags: [],
    additional_contents: [
        {
            title: "",
            content: "",
            images: [], // Array for multiple additional content images
        },
    ],
});
...
const addContent = () => {
    form.additional_contents.push({ title: "", content: "" });
};
                ...
                >
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="mt-4">
                            ...
                            <InputError
                                :message="form.errors.additional_contents"
                                class="mt-2"
                            />
                        </div>
